...
/******************************************************************************/
/*									                                                          */
/*	Kroenke and Auer - Database Processing (15th Edition) Chapter 10B         */
/*							                                                              */
...
SELECT WORK.TITLE, ARTIST.FIRSTNAME, ARTIST.LASTNAME
FROM WORK
JOIN ARTIST ON WORK.ARTISTID = ARTIST.ARTISTID
ORDER BY LASTNAME ASC;
    
SELECT ARTIST.LASTNAME, COUNT(WORK.ARTISTID) AS "No. of Works"
FROM WORK
JOIN ARTIST ON WORK.ARTISTID = ARTIST.ARTISTID
GROUP BY LASTNAME
ORDER BY LASTNAME ASC;
